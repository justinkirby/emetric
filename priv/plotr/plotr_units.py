...
def _bytes_kb(b): return b/1024.0 if b != 0 else 0
def _words_kb(w): return _bytes_kb(w*8.0)
def _none(n): return n
...
class Units:
    def info(self,key):
        if key in self.units:
            ...
            if rv["unit"] is None:
                rv["unit"] = ""
            if rv["convert"] is None:
                rv["convert"] = _none
            if rv["label"] is None:
                rv["label"] = key
            return rv
        else:
            return {"unit":"","convert":_none,"label":key}
    def __init__(self):
        ...
        self.units = {
            ...
            "sys_total":{"unit":"KB","convert":_bytes_kb,"label":"Total Memory Alloc"},
            "sys_processes":{"unit":"KB","convert":_bytes_kb,"label":"Memory Alloc'd by Erlang Processes"},
            "sys_processes_used":{"unit":"KB","convert":_bytes_kb,"label":"Memory Used by Erlang Processes"},
            "sys_system":{"unit":"KB","convert":_bytes_kb,"label":"Memory Alloc by Erlang Emulator"},
            "sys_atom":{"unit":"KB","convert":_bytes_kb,"label":"Memory Alloc for Erlang Atoms"},
            "sys_atom_used":{"unit":"KB","convert":_bytes_kb,"label":"Memory Used by Erlang Atoms"},
            "sys_binary":{"unit":"KB","convert":_bytes_kb,"label":"Memory Alloc'd for Erlang Binary"},
            "sys_code":{"unit":"KB","convert":_bytes_kb,"label":"Memory Alloc'd for Erlang Code"},
            "sys_ets":{"unit":"KB","convert":_bytes_kb,"label":"Memory Alloc'd for erts"},
            ...
            "mnesia_table_voalte_caps_info_memory":{"unit":"KB","convert":_words_kb,"label":None},
            ...
            "mnesia_table_pubsub_subscription_memory":{"unit":"KB","convert":_words_kb,"label":None},
            ...
            "mnesia_table_roster_version_memory":{"unit":"KB","convert":_words_kb,"label":None},
            ...
            "mnesia_table_session_memory":{"unit":"KB","convert":_words_kb,"label":None},
            ...
            "mnesia_table_irc_custom_memory":{"unit":"KB","convert":_words_kb,"label":None},
            ...
            "mnesia_table_pubsub_last_item_memory":{"unit":"KB","convert":_words_kb,"label":None},
            ...
            "mnesia_table_pubsub_item_memory":{"unit":"KB","convert":_words_kb,"label":None},
            ...
            "mnesia_table_muc_room_memory":{"unit":"KB","convert":_words_kb,"label":None},
            ...
            "mnesia_table_muc_online_room_memory":{"unit":"KB","convert":_words_kb,"label":None},
            ...
            "mnesia_table_acl_memory":{"unit":"KB","convert":_words_kb,"label":None},
            ...
            "mnesia_table_privacy_memory":{"unit":"KB","convert":_words_kb,"label":None},
            ...
            "mnesia_table_last_activity_memory":{"unit":"KB","convert":_words_kb,"label":None},
            ...
            "mnesia_table_mod_msg_delivery_memory":{"unit":"KB","convert":_words_kb,"label":None},
            ...
            "mnesia_table_pubsub_index_memory":{"unit":"KB","convert":_words_kb,"label":None,"label":None},
            ...
            "mnesia_table_vcard_search_memory":{"unit":"KB","convert":_words_kb,"label":None,"label":None},
            ...
            "mnesia_table_config_memory":{"unit":"KB","convert":_words_kb,"label":None},
            ...
            "mnesia_table_local_config_memory":{"unit":"KB","convert":_words_kb,"label":None,"label":None},
